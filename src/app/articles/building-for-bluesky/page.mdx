...
import designSystem from './eggs.png'
...
export const article = {
  ...
  description:
    'Apparently the American electorate only cares about egg prices. Luckily, there"s a new social network to track their prices with.',
}
...
Building a bot to track the number one issue of the 2024 election.
