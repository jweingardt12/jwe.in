...
export default function Contact() {
  return (
    ...
    >
      <div className="relative isolate px-6 py-8 sm:py-1 lg:px-8">
        <svg
          aria-hidden="true"
          className="absolute inset-0 -z-10 size-full stroke-zinc-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)] dark:stroke-zinc-800"
        >
          <defs>
            <pattern
              x="50%"
          ...
          <svg
            x="50%"
            y={-64}
            className="overflow-visible fill-zinc-50 dark:fill-zinc-900"
          >
            <path
