...
const TldrCard = ({ jobData, isLoading }) => {
  ...
  if (jobData && !jobData.error) {
    return (
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-white via-purple-50/50 to-white dark:from-zinc-900 dark:via-purple-900/10 dark:to-zinc-900 shadow-xl border border-purple-200/50 dark:border-purple-500/20">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100/50 via-transparent to-transparent dark:from-purple-500/10 dark:via-transparent dark:to-transparent" />
        <SparklesCore
          className="absolute inset-0 h-full w-full"
          particleColor="rgba(168, 85, 247, 0.4)"
          particleDensity={100}
