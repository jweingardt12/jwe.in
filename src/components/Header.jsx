...
function MobileNavigation({ isContactOpen, setIsContactOpen, ...props }) {
  return (
    <Popover {...props}>
      ...
      <PopoverPanel className="fixed inset-x-4 top-8 z-[9999] origin-top rounded-3xl bg-white dark:bg-zinc-900 p-8 ring-1 ring-zinc-900/5 dark:ring-zinc-800 shadow-lg">
