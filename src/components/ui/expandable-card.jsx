...
export const ExpandableCard = ({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed inset-0 bg-black/40 backdrop-blur-sm z-10 transition-all duration-300',
          isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
        )}
      />
      <div
        className={cn(
          'fixed inset-0 grid place-items-center z-[100] transition-all duration-300',
          isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
        )}
      >
            <button
              ...
              className={cn(
                'absolute top-4 right-4 flex items-center justify-center bg-white dark:bg-neutral-900 rounded-full h-8 w-8 shadow-lg transition-all duration-200 z-[101]',
                isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
              )}
            >
              <svg
